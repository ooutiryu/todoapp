...
<script>
  ...
  console.log(add);
function addForm() {
    add.insertAdjacentHTML('afterbegin', '<tr class="tableattr"><th scope="row">test</th><td>セル</td><td>セル</td><td><button class="removebutton" onclick="clickBtn2(this)">-</button></td></tr>');
}
